...
var app = new Vue({
  ...
  data: {
   ...
   formDislikes: 3,
    message: "hello vue!",
    tasks: [
      { text: "Развернуть окружение в Codepen", done: true, likes: 1, dislikes: 4 },
      { text: "Пройти курс по Vue", done: false, likes: 2, dislikes: 5 },
      { text: "Сделать интернет-магазин на Vue", done: false, likes: 2, dislikes: 6 },
    ],
  ...
  methods: {
    ...
    countLikes() {
      return this.headerLikes + this.formLikes +
       this.tasks.reduce((value, task) => value + task.likes, 0);
    },
    countDislikes() {
      return this.headerDislikes + this.formDislikes +
